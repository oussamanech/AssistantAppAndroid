...
class AssistantAdapter : RecyclerView.Adapter<AssistantAdapter.ViewHolder>() {
    ...
    class ViewHolder (itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        val assisstantMessage: TextView = itemView.findViewById(R.id.assistant_message)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = layoutInflater
            .inflate(R.layout.assistent_item_layout,parent,false) as ConstraintLayout
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.assisstantMessage.text = item.assistant_message
